...
function matchCase(word, orig) {
  var first = orig.charAt(0);
  var second = orig.charAt(1);

  if (/[a-z]/.test(first)) return word.toLowerCase();
  if (/[A-Z]/.test(second)) return word.toUpperCase();
